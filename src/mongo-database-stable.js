...
var Database = /** @class */ (function () {
    ...
    Database.prototype.create_post = function (post) {
        return __awaiter(this, void 0, void 0, function () {
            var db, collection, result, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.db(this.dbName)];
                    case 1:
    ...
    Database.prototype.read_post = function (page) {
        return __awaiter(this, void 0, void 0, function () {
            var db, collection, p, result, result, error_10;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.db(this.dbName)];
                    case 1:
                    ...
                    case 3:
                        _a.trys.push([3, 8, , 9]);
                        if (!(p === NaN)) return [3 /*break*/, 5];
                        return [4 /*yield*/, collection.find().limit(1).toArray()];
                    case 4:
                        result = _a.sent();
                        console.log("result = ");
                        console.dir(result[0]);
                        return [2 /*return*/, result[0]];
                    case 5: return [4 /*yield*/, collection.find().skip(p).limit(1).toArray()];
                    case 6:
                        result = _a.sent();
                        console.log("result = ");
                        console.dir(result[0]);
